...
```json
"features": {
    "ghcr.io/JEFuller/features/nvidia-cuda:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/JEFuller/features/blob/main/src/nvidia-cuda/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._

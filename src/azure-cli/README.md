...
```json
"features": {
    "ghcr.io/JEFuller/features/azure-cli:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/JEFuller/features/blob/main/src/azure-cli/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
